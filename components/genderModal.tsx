              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="mt-3 text-center sm:mt-2">
                  ...
                  <p className="mt-3 text-gray-300 text-left text-lg">
                    This website is committed to an experience that welcomes people from all walks
                    of life and promotes body-positivity and gender fluidity. This application
                    provides calculations and fitness guidance based on body composition between
                    biological sexes. For example, biological males have more muscle mass and bone
                    mass while having lower body fat than biological females. For this reason, we
                    request users to choose between these two options.
                  </p>
                </div>
              </div>
