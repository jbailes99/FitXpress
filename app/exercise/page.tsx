              ...
              <div className='mt-24 text-black'>
                ...
                {selectedCategory && (
                  <select
                    ...
                    onChange={e => setNewExerciseEntry({ ...newExerciseEntry, type: e.target.value })}
                  >
                    <option value='' disabled>
                ...
                {newExerciseEntry.type && ( // Check if an exercise type is selected
                  <input
                    ...
                    onChange={e => setNewExerciseEntry({ ...newExerciseEntry, reps: e.target.value })}
                  />
                )}
                {newExerciseEntry.type && ( // Check if an exercise type is selected
                  <input
                    ...
                    onChange={e => setNewExerciseEntry({ ...newExerciseEntry, additionalInfo: e.target.value })}
                  />
                )}
              </div>
